...
\begin{tabular}{l l l}
	...
	\hline
	$D_{\mathrm{max}}$ & ((( doses.percent.max|percent ))) & ((( doses.absolute.max ))) \\
	$D_{\mathrm{min}}$ & ((( doses.percent.min|percent ))) & ((( doses.absolute.min ))) \\
	$D_{90}$ & ((( doses.percent['90']|percent ))) & ((( doses.absolute['90'] ))) \\
	$D_{95}$ & ((( doses.percent['95']|percent ))) & ((( doses.absolute['95'] ))) \\
	$D_{100}$ & ((( doses.percent['100']|percent ))) & ((( doses.absolute['100'] )))
\end{tabular}
\end{table}
