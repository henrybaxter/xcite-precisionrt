...
% contours['xy']
% contours['yz']
The lesion is Note that the plane is always sliced through the center of the lesion, which is why the lesion
...
((* for plane, contours in contour_plots.items() *))
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{(((plot.path|strip_extension)))}
	\caption{(((plot.name)))}
	\end{figure}
	((* endfor *))
((* endfor *))
