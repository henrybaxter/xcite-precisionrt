...
((* for plane, contours in contour_plots.items() *))
	...
	\begin{figure}[H]
	\centering
	\includegraphics[scale=2.0]{(((plot.path|strip_extension)))}
	\caption{(((plot.name)))}
	\end{figure}
	((* endfor *))
((* endfor *))
...
\subsection{Targs to Skin}
\begin{table}[H]
\begin{tabular}{l l l l l}
	& Stationary & Weighted & Arc & Weighted Arc \\
	\hline
	CI & ((( conformity['stationary']|f ))) & ((( conformity['stationary-weighted']|f ))) & ((( conformity['arc']|f ))) & ((( conformity['arc-weighted']|f ))) \\
